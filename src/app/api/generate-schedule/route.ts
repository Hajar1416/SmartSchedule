...
MANDATORY BREAK: 12:00 PM - 1:00 PM (1 hour) on Sunday, Monday, Tuesday, Wednesday, and Thursday
- The entire 12:00-1:00 PM time block must be COMPLETELY FREE
- OR classes MUST START AT OR AFTER 1:00 PM (e.g., start at 1:00 PM or 2:00 PM)
...
⚠️ CLASS DURATION AND TIMING ⚠️
- Each class is either 50 minutes (1 period) or 100 minutes (2 consecutive periods)
- Classes can only be scheduled between 8:00 AM and 3:00 PM
- Example VALID schedules:
  - 8:00-8:50, 9:00-9:50, 10:00-11:40, 1:00-1:50, 2:00-2:50
- Example INVALID schedules:
  - Any class that overlaps 12:00-1:00 PM break
  - Classes starting before 8:00 AM or ending after 3:00 PM
