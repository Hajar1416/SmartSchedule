              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFormData({...formData, is_lab: !!checked})}
                  />
                  <Label htmlFor="is_fixed">Lab Course</Label>
                </div>
                ...
                <TableBody>
                  {filteredCourses.length === 0 ? (
                    ...
                    filteredCourses.map((course) => {
                      ...
                      const category = (course as any).category || 'N/A'
                      ...
                      return (
                        <TableRow key={course.id}>
                          ...
                          <TableCell>
                            <Badge variant={course.is_lab ? "destructive" : "secondary"}>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-2xl font-bold">
                    {courses.filter(c => !c.is_lab).length}
                  </p>
