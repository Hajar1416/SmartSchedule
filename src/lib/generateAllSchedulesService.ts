...
export class GenerateAllSchedulesService {
  ...
  private static async generateGroupScheduleWithAI(
    ...
    const constraints: SchedulingConstraints = {
      ...
      rules: [
        ...
        'No classes during 12:00-1:00 break time',
  ...
  // Slots in 50-min increments, combined into 100-min for double periods
  const timeSlots = [
    { start: '08:00', end: '08:50' },
    { start: '09:00', end: '09:50' },
    { start: '10:00', end: '10:50' },
    { start: '11:00', end: '11:50' }, // Avoid scheduling here if it's single 50-min period? 
    { start: '12:00', end: '12:50', break: true }, // Break
  ...
  private static async resolveConflicts(schedule: GeneratedSchedule): Promise<GeneratedSchedule> {
    try {
      ...
      const availableTimes = ['08:00', '09:00', '10:00', '11:00', '13:00', '14:00', '15:00'];
  ...
  private static generateFallbackEditedSchedule(constraints: any, courses: any[]): any[] {
    return courses.slice(0, 6).map((course, index) => ({
      ...
      section_label: 'A',
      timeslot: {
        day: ['Sunday','Monday', 'Tuesday', 'Wednesday', 'Thursday'][index % 4],
