...
CREATE TABLE public.schedule_versions (
  ...
  CONSTRAINT schedule_versions_parent_version_id_fkey FOREIGN KEY (parent_version_id) REFERENCES public.schedule_versions(id),
  CONSTRAINT schedule_versions_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.users(id),
  CONSTRAINT schedule_versions_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id),
  CONSTRAINT schedule_versions_level_semester_version_unique UNIQUE (level, semester, version_number)
);
